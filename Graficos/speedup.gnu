...
# line styles
set style line 1 lw 2 pt 7 ps 1 lc rgb '#B2182B' # red
set style line 2 lw 2 pt 7 ps 1 lc rgb '#D6604D' # red-orange
set style line 3 lw 2 pt 7 ps 1 lc rgb '#F4A582' #
set style line 4 lw 2 pt 7 ps 1 lc rgb '#41AB5D' # medium yellow-green
set style line 5 lw 2 pt 7 ps 1 lc rgb '#D1E5F0' # pale blue
set style line 6 lw 2 pt 7 ps 1 lc rgb '#92C5DE' #
set style line 7 lw 2 pt 7 ps 1 lc rgb '#4393C3' # medium blue
set style line 8 lw 2 pt 7 ps 1 lc rgb '#2166AC' # dark blue
...
plot $data1 u ($1):($5/$2) t "OMPC" ls 2, \
	""	u ($1):($5/$3) t " Charm++" ls 4, \
	""	u ($1):($5/$4) t "StarPU" ls 7
...
set obj 1 rect from graph 0,0 to graph 1,1 fc rgb 0xf0f0f0 behind
plot $data2 u ($1):($5/$2) t "OMPC" ls 2, \
	""	u ($1):($5/$3) t " Charm++" ls 4, \
	""	u ($1):($5/$4) t "StarPU" ls 7
...
set obj 1 rect from graph 0,0 to graph 1,1 fc rgb 0xf0f0f0 behind
plot $data3 u ($1):($5/$2) t "OMPC" ls 2, \
	""	u ($1):($5/$3) t " Charm++" ls 4, \
	""	u ($1):($5/$4) t "StarPU" ls 7
...
set obj 1 rect from graph 0,0 to graph 1,1 fc rgb 0xf0f0f0 behind
plot $data4 u ($1):($5/$2) t "OMPC" ls 2, \
	""	u ($1):($5/$3) t " Charm++" ls 4, \
	""	u ($1):($5/$4) t "StarPU" ls 7
